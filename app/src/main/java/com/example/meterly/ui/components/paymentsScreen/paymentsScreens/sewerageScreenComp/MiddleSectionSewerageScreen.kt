    ...
    Column(
        ...
        Card(
            ...
            Column(
                ...
                OutlinedTextField(
                    value = rate4,
                    onValueChange = onRateEndChange4,
                    label = { Text("Тарифи") },
                ...
                Button(
                    onClick = {
                        paymentViewModel.calculate(
                            utility = UtilityType.SEWERAGE,
                            begin = monthBegin4.toDoubleOrNull() ?: 0.0,
                            end = monthEnd4.toDoubleOrNull() ?: 0.0,
                            rate = rate4.toDoubleOrNull() ?: 0.0
                        )
                    },
                    modifier = Modifier
                        .fillMaxWidth()
